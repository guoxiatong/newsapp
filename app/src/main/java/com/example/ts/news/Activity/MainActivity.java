...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        img_main.setImageResource(R.drawable.homepage1);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.layout_main: {
                ...
                img_main.setImageResource(R.drawable.homepage1);
                img_seting.setImageResource(R.drawable.setting0);
                img_mine.setImageResource(R.drawable.mine0);
            ...
            case R.id.layout_setting: {
                ...
                img_main.setImageResource(R.drawable.homepage0);
                img_seting.setImageResource(R.drawable.setting1);
                img_mine.setImageResource(R.drawable.mine0);
            }
            break;
